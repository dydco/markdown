...
Двете комбинации от символи могат да се съчетаят за постигането на двоен ефект: удебелен и курсивен. Текстът се обгражда в началото с `**_`и в края с `_**`, напр. `**_удебелен и курсивен_** текст` (или алтернативно с `__*` и  `*__`).
